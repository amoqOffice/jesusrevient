    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <a href="{{ route('back.activite.create') }}" class="font-weight-bold btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> Ajouter un(e) Activite</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($activites as $activite)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ $activite->img }}" class="rounded-circle mr-2 img-fluid" style="width: 45px; height: 45px;">
